...
def realizar_operacoes():
    global acumula
    resultado = eval(acumula)
    widget0.config(text=resultado)
    acumula = str(resultado)
...
widget10 = tk.Button(janela, text="-", bg="red",width=10,command=lambda: calcula_("-"))
widget11 = tk.Button(janela, text="+", bg="red",width=10,command=lambda: calcula_("+"))
widget12 = tk.Button(janela, text="/", bg="red",width=10,command=lambda: calcula_("/"))
widget13 = tk.Button(janela, text="x", bg="red",width=10,command=lambda: calcula_("*"))
...
widget16 = tk.Button(janela, text="=", bg="red",width=10,command=realizar_operacoes)
